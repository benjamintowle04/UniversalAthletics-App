-- V1__init.sql
-- Initial schema and seed data converted from database/create.sql
-- Note: Flyway manages schema versions. Do NOT include CREATE DATABASE or USE statements here.

-- Disable foreign key checks for table drops and re-creation
SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS;
SET FOREIGN_KEY_CHECKS=0;

-- Create the hibernate_sequences table for ID generation (used by application)
...
-- Drop tables if they exist (safe idempotent migration step)
...
CREATE TABLE IF NOT EXISTS Connection_Request (
    ...
    Sender_Firebase_ID VARCHAR(255), 
    Receiver_Type ENUM('COACH', 'MEMBER') NOT NULL,
    Receiver_ID INT(11) NOT NULL,
    Receiver_Firebase_ID VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS Session ( 
    ...
    Member_Firebase_ID VARCHAR(255),
...
INSERT INTO Coach (First_Name, Last_Name, Email, Phone, Biography_1, Biography_2, Profile_Pic, Bio_Pic_1, Bio_Pic_2, Location, Firebase_ID) VALUES (
    ...
    '(314)-915-1640',
    'My name is Mekhi Holmes or K1. I am a senior  at Simpson College majoring in sociology and a 3 year starting defensive back for the Simpson Storm football team. My hometown is St. Louis MO, where I went to Hazelwood East High School and played football, basketball, and baseball. Sports have always been a big part of my life and have blessed me with many of the opportunities I have today. I am an athlete that loves competition and striving for the best! Im fairly new to training, but I have attended a large amount of high level training sessions as an athlete in various sports and Im excited to start my journey as a trainer!, but I have attended a large amount of high level training sessions as an athlete in various sports and Im excited to start my journey as a trainer!',
...
-- Member insert statements removed
