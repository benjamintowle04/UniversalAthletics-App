...
interface ScheduleMonthViewMobileUIProps extends RouterProps {
  sessions: SessionEntity[];
  loading: boolean;
  error: string | null;
}

export default function ScheduleMonthViewMobileUI({ sessions, loading, error, navigation }: ScheduleMonthViewMobileUIProps) {
      ...
      <View className="flex-row items-center justify-between">
        <View className="flex-row items-center flex-1">
          ...
          <View className="flex-1">
            ...
            <Text className="text-sm text-gray-500">with {event.participantName}</Text>
            {event.location && (
