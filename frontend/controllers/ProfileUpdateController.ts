...
export const updateMemberProfile = async (
  ...
  try {
    ...
    const memberInfoJson = {
      ...
      firebaseID: FIREBASE_AUTH.currentUser?.uid || memberData.firebaseId,
    };
...
export const updateCoachProfile = async (
  ...
  try {
    ...
    const coachInfoJson = {
      ...
      firebaseID: FIREBASE_AUTH.currentUser?.uid || coachData.firebaseId,
    };
...
export const updateMemberSkillsWithFormData = async (
  ...
  const firebaseId = userData?.firebaseId || FIREBASE_AUTH.currentUser?.uid;
  if (!firebaseId) {
